...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(602, 395)
        self.cancelBtn = QtWidgets.QPushButton(parent=Dialog)
        self.cancelBtn.setGeometry(QtCore.QRect(320, 340, 81, 41))
...
"}")
        ...
        self.confirmBtn.setGeometry(QtCore.QRect(450, 340, 81, 41))
        self.confirmBtn.setStyleSheet("QPushButton{border: none;\n"
...
"}")
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(31, 80, 541, 231))
        ...
        self.defaultinfo = QtWidgets.QWidget(parent=self.layoutWidget)
        self.defaultinfo.setObjectName("defaultinfo")
        self.layoutWidget1 = QtWidgets.QWidget(parent=self.defaultinfo)
        self.layoutWidget1.setGeometry(QtCore.QRect(10, 0, 531, 116))
        self.layoutWidget1.setObjectName("layoutWidget1")
        self._2 = QtWidgets.QGridLayout(self.layoutWidget1)
        ...
        self.dayinput = QtWidgets.QDateEdit(parent=self.layoutWidget1)
        ...
        self.timeinInput = QtWidgets.QTimeEdit(parent=self.layoutWidget1)
        ...
        self.timeoutInput = QtWidgets.QTimeEdit(parent=self.layoutWidget1)
        ...
        self.postinginfo = QtWidgets.QWidget(parent=self.layoutWidget)
        self.postinginfo.setObjectName("postinginfo")
        self.layoutWidget2 = QtWidgets.QWidget(parent=self.postinginfo)
        self.layoutWidget2.setGeometry(QtCore.QRect(10, 0, 531, 91))
        ...
        self.startInput = QtWidgets.QDateEdit(parent=self.layoutWidget2)
        ...
        self.endInput = QtWidgets.QDateEdit(parent=self.layoutWidget2)
        ...
        self.clientComboBox = QtWidgets.QComboBox(parent=self.layoutWidget)
        ...
        self.label_17.setGeometry(QtCore.QRect(10, 0, 251, 81))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_17.setText(_translate("Dialog", "<html><head/><body><p><span style=\" font-size:24pt;\">Add Schedule</span></p></body></html>"))
...
class AddSchedule(QDialog, Ui_Dialog):
    def __init__(self, which, sched_id, admin):
        ...
        if which == "Edit":
            self.label_17.setText(QtCore.QCoreApplication.translate("Dialog", "<html><head/><body><p><span style=\" font-size:24pt;\">Edit Schedule</span></p></body></html>"))
