...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(30, 100, 321, 301))
        ...
        self.msgID = QtWidgets.QComboBox(parent=self.layoutWidget)
        ...
        self.msg = QtWidgets.QTextBrowser(parent=self.layoutWidget)
        ...
        self.schedID = QtWidgets.QComboBox(parent=self.layoutWidget)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.typeinput.setItemText(0, _translate("Dialog", "Scheduled Client"))
        self.typeinput.setItemText(1, _translate("Dialog", "Assigned Technician"))
        self.label_2.setText(_translate("Dialog", "Message ID:"))
        self.label_3.setText(_translate("Dialog", "Recipient Type:"))
...
class SMS(QDialog,Ui_Dialog):
    ...
    def submit(self):
        ...
        if send_to is None:
            self.notif(QMessageBox.Icon.Warning, "No Message")
        ...
        if phone_no is None:
            self.notif(QMessageBox.Icon.Warning, "No Phone Number")
            self.responseText.setText("No Phone Number")
        else:
            try:    
                ...
                self.notif(QMessageBox.Icon.Warning, "No Serial GSM Module Inserted")
                self.responseText.setText("No Serial GSM Module Inserted")
