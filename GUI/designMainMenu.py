...
"border-radius: 10px;")
        ...
        self.scheduleTable.setGeometry(QtCore.QRect(20, 180, 981, 531))
...
"padding-right: 100px")
        ...
        self.saleTable.setGeometry(QtCore.QRect(20, 180, 981, 531))
        ...
        self.layoutWidget3.setGeometry(QtCore.QRect(570, 50, 401, 101))
        ...
        self.addSalesBtn = QtWidgets.QPushButton(parent=self.layoutWidget3)
        self.addSalesBtn.setStyleSheet("")
        self.addSalesBtn.setObjectName("addSalesBtn")
        self.gridLayout_2.addWidget(self.addSalesBtn, 0, 2, 1, 1)
        self.currentBtn = QtWidgets.QPushButton(parent=self.layoutWidget3)
        self.currentBtn.setObjectName("currentBtn")
        self.gridLayout_2.addWidget(self.currentBtn, 1, 0, 1, 1)
        self.previousBtn = QtWidgets.QPushButton(parent=self.layoutWidget3)
        self.previousBtn.setObjectName("previousBtn")
        self.gridLayout_2.addWidget(self.previousBtn, 1, 1, 1, 1)
        self.allBtn = QtWidgets.QPushButton(parent=self.layoutWidget3)
        self.allBtn.setStyleSheet("")
        self.allBtn.setObjectName("allBtn")
        self.gridLayout_2.addWidget(self.allBtn, 1, 2, 1, 1)
        self.dateLabel = QtWidgets.QLabel(parent=self.salesPage)
        self.dateLabel.setGeometry(QtCore.QRect(50, 130, 391, 41))
        self.dateLabel.setLineWidth(0)
        self.dateLabel.setScaledContents(False)
        self.dateLabel.setIndent(3)
...
"padding-right: 100px")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.salesLabel.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:28pt;\">Sales (Current)</span></p></body></html>"))
        ...
        self.currentBtn.setText(_translate("MainWindow", "Current"))
        self.previousBtn.setText(_translate("MainWindow", "Previous"))
        self.allBtn.setText(_translate("MainWindow", "All"))
        self.dateLabel.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:16pt;\">Date: </span></p></body></html>"))
